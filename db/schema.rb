...
ActiveRecord::Schema.define(version: 2019_03_16_011049) do
  ...
  create_table "admin_users", options: "ENGINE=MyISAM DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "ckeditor_assets", options: "ENGINE=MyISAM DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "contacts", options: "ENGINE=MyISAM DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
    t.string "email"
    t.string "topic"
  ...
  create_table "friendly_id_slugs", options: "ENGINE=MyISAM DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "users", options: "ENGINE=MyISAM DEFAULT CHARSET=latin1", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "etat_user", default: 0, null: false
